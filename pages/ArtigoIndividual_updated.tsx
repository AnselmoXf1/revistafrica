...
const ARTIGOS_DADOS = [
  ...
  },
  {
    ...
    title: 'Microbiologia Geral (Manual)',
    author: 'Jean Berg',
    year: 2026,
    description: 'Manual completo de microbiologia para estudantes de ciências biológicas.',
    category: 'Educação',
    pdfUrl: '#',
    longDescription: 'Manual abrangente que cobre os fundamentos da microbiologia, incluindo estrutura bacteriana, virologia, micologia e técnicas laboratoriais. Ideal para estudantes de biologia, medicina e áreas afins que necessitam de uma referência prática e atualizada.'
  },
  {
  ...
  },
  {
    ...
    title: 'Criação e maneio de aves poedeiras',
    author: 'Glenda Alves Ferreira Prado',
    year: 2015,
    description: 'Manual técnico sobre criação e manejo de aves poedeiras com técnicas modernas.',
    category: 'Outros / Técnicos',
    pdfUrl: '#',
    longDescription: 'Manual técnico completo sobre a criação comercial de aves poedeiras, abordando genética, nutrição, manejo sanitário, instalações e gestão da produção para maximizar a produtividade e qualidade dos ovos.'
  },
  {
    id: 'manual-cultivo-pimenta-maneio',
    title: 'Manual de Cultivo de Pimenta (Maneio)',
    author: 'Fabio Lutel',
    year: 2017,
    description: 'Manual prático para cultivo de pimenta com técnicas de maneio adequadas.',
    category: 'Outros / Técnicos',
    pdfUrl: '#',
    longDescription: 'Manual prático que ensina técnicas de cultivo de pimenta para pequenos e médios produtores. Inclui informações sobre variedades, preparo do solo, controle de pragas e doenças, colheita e pós-colheita.'
  },
  {
    id: 'maneio-suinocultura-elementos-principais-criacao',
    title: 'Maneio de Suinocultura e seus elementos principais de criação',
    author: 'Emater Livraria',
    year: 2019,
    description: 'Guia completo sobre maneio de suinocultura e elementos principais de criação.',
    category: 'Outros / Técnicos',
    pdfUrl: '#',
    longDescription: 'Compilação das técnicas mais modernas de maneio na suinocultura, com foco em bem-estar animal, eficiência produtiva e sustentabilidade ambiental. Ideal para produtores que desejam atualizar suas práticas.'
  }
];
